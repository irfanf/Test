...
namespace CubeManProject
{
	public class PlayerCubeMan : MonoBehaviour
	{
		...
		//	腕と足を回転させるためのスクリプト
		[SerializeField] private LegAndArmAnimation rotAnimation;
		//	弾を発射するためのスクリプト
		[SerializeField] private ThrowAnimation throwScript;
		//	弾を連続して生成するまでの時間(秒)
		[SerializeField] private float bulletCoolTime = 0.5f;
